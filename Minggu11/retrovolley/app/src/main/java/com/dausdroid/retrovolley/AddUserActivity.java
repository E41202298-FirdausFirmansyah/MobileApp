package com.dausdroid.retrovolley;
...
import com.dausdroid.retrovolley.retrofit.MethodHTTP;
...
public class AddUserActivity extends AppCompatActivity {
    ...
    public void submitByRetrofit(User user){
        ...
        Retrofit.Builder builder= new Retrofit.Builder().baseUrl("http://192.168.43.122/volley/").addConverterFactory(GsonConverterFactory.create());
    ...
    public void submitByVolley(User user){
        Gson gson = new Gson();
        String URL = "http://192.168.43.122/volley/User_Registration.php";
